from us_visa.entity.config_entity import ModelEvaluationConfig, LocalModelEvaluationConfig
from us_visa.entity.artifact_entity import ModelTrainerArtifact, DataIngestionArtifact, ModelEvaluationArtifact,LocalModelEvaluationArtifact
...
class LocalModelEvaluation:
    ...
    def get_best_model(self) -> Optional[USvisaLocalModelEstimator]:
        """
        Method Name :   get_best_model
        Description :   This function is used to get model in production
        ...
        try:
            ...
            usvisa_estimator = USvisaLocalModelEstimator(model_path=model_path)
